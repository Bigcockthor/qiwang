...
CGameServiceManager::CGameServiceManager(void)
{
	...
	lstrcpyn(m_GameServiceAttrib.szClientModuleName,TEXT("SevenThree7w.exe"),CountArray(m_GameServiceAttrib.szClientModuleName));
	lstrcpyn(m_GameServiceAttrib.szServerModuleName,TEXT("SevenThree7wServer.dll"),CountArray(m_GameServiceAttrib.szServerModuleName));
